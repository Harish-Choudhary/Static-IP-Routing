...
//Structure to define device information connected to router
...
//Structure for one network vertex ie. router node
...
//structure to define graph which stores array of adjacency list
